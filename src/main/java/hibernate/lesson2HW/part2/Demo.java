...
public class Demo {
    public static void main(String[] args) {
        System.out.println(hibernate.lesson2HW.part2.ProductDAO.findById(6L));
...
//        System.out.println(ProductDAO.findByPrice(90, 0));
//        System.out.println(ProductDAO.findByPrice(0, 10));

//        System.out.println(hibernate.lesson2HW.part2.ProductDAO.findByNameSortedAsc("table new"));
